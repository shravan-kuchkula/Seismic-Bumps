...
There are 18 input variables and one binary output variable ("class").  The data are mostly numeric with 4 categorical input variables ("Seismic", "SeismoAcoustic", "Shift", and "Ghazard").  However, since the 'nbumps' variables only have a small number of discrete values, they can also be treated as categorical ordinal variables, leaving 12 categorical input variables, 6 numeric variables and one categorical (binary) output variable.  
