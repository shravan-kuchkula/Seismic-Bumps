...
This shows that the logistic regression model with all the factor variables made a correct prediction `r round(fullModelAccuracy, 2)`%  of the time.
...
With our fullModel accuracy of `r round(fullModelAccuracy, 2)`% the model is actually performing worse than if it were to predict class 0 for every record.
